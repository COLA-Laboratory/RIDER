...
class MultiGVPConv(MessagePassing):
    ...
    def forward(self, x, edge_index, edge_attr):
        ...
        '''
        x_s, x_v = x
        n_conf = x_s.shape[1]  # NOTE! This defines the number of conformations!
        ...
        return _split_multi(message, self.so, self.vo, n_conf)  # NOTE! "_split_multi" This function might be used to split multiple conformations
    ...
    def message(self, s_i, v_i, s_j, v_j, edge_attr):
        ...
        message = tuple_cat((s_j, v_j), edge_attr, (s_i, v_i))
        message = self.message_func(message)
        return _merge_multi(*message)  # NOTE! "_merge_multi" This function might be used to merge multiple conformations
